...
class PartialParse(object):
    def __init__(self, sentence):
        ...
        self.stack = ['ROOT']
        self.buffer = [text for text in self.sentence]
        self.dependencies = []
    ...
    def parse_step(self, transition):
        ...
        if transition == 'LA':
            self.dependencies.insert(0, (self.stack[-1], self.stack.pop(-2)))
        if transition == 'RA':
            self.dependencies.insert(0, (self.stack[-2], self.stack.pop(-1)))
